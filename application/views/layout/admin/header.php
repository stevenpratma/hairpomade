...
<div class="mobile-menu md:hidden">
    <div class="mobile-menu-bar">
       ...
       <!-- <img alt="Midone - HTML Admin Template" class="w-24 mt-8" src="<?= site_url('asset') ?>/admin/dist/images/logosipeta.png"> -->
        </a> 
    ...
    <div class="scrollable">
        ...
        <ul class="scrollable__content py-2">
            <li>
                <a href="<?= base_url('admin/dashboard') ?>" class="menu menu--active">
            ...
            <li>
                <a href="<?= base_url('admin/change_password_admin') ?>" class="menu">
                    <div class="menu__icon">
            ...
            <li>
                <a href="<?= base_url('welcome/logout') ?>" class="menu">
                    <div class="menu__icon">
    ...
    <div class="top-bar-boxed h-[70px] z-[51] relative border-b border-white/[0.08] mt-12 md:-mt-5 -mx-3 sm:-mx-8 px-3 sm:px-8 md:pt-0 mb-12">
        <div class="h-full flex items-center">
            ...
            <a href="" class="-intro-x hidden md:flex">
                ...
                <span class="text-white text-lg ml-3"> Hair Pomade </span>
            </a>
            <!-- END: Logo -->
            <!-- BEGIN: Breadcrumb -->
    ...
    <div class="notification-content pt-2 dropdown-menu">
        <div class="notification-content__box dropdown-content">
            ...
            <?php if (isset($bill) && !empty($bill)): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <div class="mt-5 text-slate-500">No notifications available.</div>
            <?php endif; ?>
        </div>
    </div>
</div>
            ...
            <div class="intro-x dropdown w-8 h-8">
                ...
                <div class="dropdown-menu w-56">
                    <ul class="dropdown-content bg-primary/80 before:block before:absolute before:bg-black before:inset-0 before:rounded-md before:z-[-1] text-white">
                        ...
                        <li>
                            <a href="<?= site_url('change_password_admin') ?>" class="dropdown-item hover:bg-white/5"> <i data-lucide="lock" class="w-4 h-4 mr-2"></i> Reset Password </a>
                        </li>
                        <li>
                            <hr class="dropdown-divider border-white/[0.08]">
                        </li>
        ...
        <div class="wrapper-box">
            ...
            <nav class="side-nav">
                <ul>
                    ...
                    <li>
                        <a href="<?= base_url('admin/change_password_admin') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="file-text"></i> </div>
                    ...
                    <li>
                        <a href="<?= base_url('welcome/logout') ?>" class="side-menu">
